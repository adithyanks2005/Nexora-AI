...
print(f"[Vercel] ROOT_DIR: {ROOT_DIR}")
print(f"[Vercel] sys.path: {sys.path}")

# Import the main app from backend
try:
    from backend.main import app
    print("[Vercel] Successfully imported app from backend.main")
...
# Re-export for Vercel (Vercel looks for 'app' or 'application')
application = app

print(f"[Vercel] App initialized: {app}")
print(f"[Vercel] Application initialized: {application}")
